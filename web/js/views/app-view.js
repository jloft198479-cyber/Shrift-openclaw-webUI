function buildApp() {
  ...
  root.innerHTML = ''
    ...
    + '  <div id="filter-bar">'
    + '    <span class="filter-label">最近对话</span>'
    ...
    + '      <span class="section-title">虾助手</span>'
...
+ '  <div id="dispatch-status-bar" style="display:none">'
+ '    <span class="dispatch-spinner"></span>'
+ '    <span class="dispatch-status-text">智能调度中…</span>'
+ '  </div>'
+ '  <div id="input-area">'
