const Api = {
  ...
  updateAgent: async function (agentId, data) {
    ...
    tasks.push(this._fetch('/api/agents/' + encodeURIComponent(agentId), {
      method: 'PUT',
      body: JSON.stringify({ name: data.name, description: data.description, avatar: data.avatar, model: data.model }),
    }));
    ...
    if (data.skills !== undefined) {
      tasks.push(this._fetch('/api/agents/' + encodeURIComponent(agentId) + '/skills', {
        method: 'PUT',
