...
const AttachmentBar = {
  ...
  _getFileIcon: function (mimeType) {
    if (mimeType.indexOf('image/') === 0) return '<span class="att-icon">🖼</span>';
    if (mimeType.indexOf('pdf') >= 0) return '<span class="att-icon">📄</span>';
    if (mimeType.indexOf('zip') >= 0 || mimeType.indexOf('rar') >= 0 || mimeType.indexOf('tar') >= 0 || mimeType.indexOf('7z') >= 0) return '<span class="att-icon">📦</span>';
    if (mimeType.indexOf('text') >= 0 || mimeType.indexOf('javascript') >= 0 || mimeType.indexOf('json') >= 0 || mimeType.indexOf('xml') >= 0 || mimeType.indexOf('html') >= 0 || mimeType.indexOf('css') >= 0) return '<span class="att-icon">📝</span>';
    if (mimeType.indexOf('sheet') >= 0 || mimeType.indexOf('excel') >= 0) return '<span class="att-icon">📊</span>';
    if (mimeType.indexOf('word') >= 0 || mimeType.indexOf('document') >= 0) return '<span class="att-icon">📃</span>';
    return '<span class="att-icon">📎</span>';
  },
};
